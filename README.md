...
[![GoDoc](https://godoc.org/github.com/benjaminchencobinhood/stellar?status.svg)](https://godoc.org/github.com/benjaminchencobinhood/stellar)
[![Go Report Card](https://goreportcard.com/badge/github.com/benjaminchencobinhood/stellar)](https://goreportcard.com/report/github.com/benjaminchencobinhood/stellar)
...
You can use dep yourself in your project and add stellar go as a vendor'd dependency, or you can just drop this repos as `$GOPATH/src/github.com/benjaminchencobinhood/stellar` to import it the canonical way (you still need to run `dep ensure -v`).
...
In addition to the packages described above, this repository contains various packages related to working with the Stellar network from a go program.  It's recommended that you use [godoc](https://godoc.org/github.com/benjaminchencobinhood/stellar#pkg-subdirectories) to browse the documentation for each.
