...
[Prebuilt binaries](https://github.com/benjaminchencobinhood/stellar/releases) of the federation server are available on the [releases page](https://github.com/benjaminchencobinhood/stellar/releases).
...
```
go get -u github.com/benjaminchencobinhood/stellar/services/federation
```
