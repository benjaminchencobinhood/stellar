...
[Prebuilt binaries](https://github.com/benjaminchencobinhood/stellar/releases) of horizon are available on the 
[releases page](https://github.com/benjaminchencobinhood/stellar/releases).

See [the old releases page](https://github.com/stellar/horizon/releases) for prior releases

| Platform       | Binary file name                                                                         |
|----------------|------------------------------------------------------------------------------------------|
| Mac OSX 64 bit | [horizon-darwin-amd64](https://github.com/benjaminchencobinhood/stellar/releases/download/horizon-v0.12.0-testing/horizon-v0.12.0-testing-darwin-amd64.tar.gz)      |
| Linux 64 bit   | [horizon-linux-amd64](https://github.com/benjaminchencobinhood/stellar/releases/download/horizon-v0.12.0-testing/horizon-v0.12.0-testing-linux-amd64.tar.gz)       |
| Windows 64 bit | [horizon-windows-amd64.exe](https://github.com/benjaminchencobinhood/stellar/releases/download/horizon-v0.12.0-testing/horizon-v0.12.0-testing-windows-amd64.zip) |
...
Then, simply run `go install github.com/benjaminchencobinhood/stellar/services/horizon`.  After successful
