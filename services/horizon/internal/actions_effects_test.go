...
import (
	...
	"github.com/benjaminchencobinhood/stellar/protocols/horizon/effects"
)
...
func TestEffectActions_Index(t *testing.T) {
	...
	t.Run("omnibus test", func(t *testing.T) {
		...
		// test streaming, regression for https://github.com/benjaminchencobinhood/stellar/services/horizon/internal/issues/147
