...
1. Clone horizon's source:  `go get github.com/benjaminchencobinhood/stellar && cd $GOPATH/src/github.com/benjaminchencobinhood/stellar/`
2. Under the project folder, download external dependencies: `glide install`
3. Build the binary: `go install github.com/benjaminchencobinhood/stellar/services/horizon`
