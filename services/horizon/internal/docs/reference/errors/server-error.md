...
If you are encountering this error on the public Stellar infrastructure, please report an error on [Horizon's issue tracker](https://github.com/benjaminchencobinhood/stellar/issues) and include the instance attribute.
