...
Download the binary from [the release page](https://github.com/benjaminchencobinhood/stellar/releases/tag/bifrost-v0.0.2) and use it with it's [Bifrost JS SDK](https://github.com/stellar/bifrost-js-sdk).
...
* `stellar`
  ...
  * `horizon` - URL to [horizon](https://github.com/benjaminchencobinhood/stellar/tree/master/services/horizon) server
